...
export const DEMO_TEMPLATE: InputTemplate = {
  fields: [
    ...
    { key: "vacancyRate", label: "Vacancy allowance", type: "percent", group: "Income", unit: "%", defaultValue: 0, step: 1 },
    { key: "downPaymentRate", label: "Own payment", type: "percent", group: "Finance", unit: "%", defaultValue: 20, step: 5 },
    { key: "interestRate", label: "Mortgage rate", type: "percent", group: "Finance", unit: "%", defaultValue: 2.5, step: 0.1 },
