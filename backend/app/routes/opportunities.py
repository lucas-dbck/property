    ...
    return OpportunityInputTemplateRead(
        fields=[
            ...
            OpportunityInputField(
                ...
                group="purchase",
                value_type="percent",
                description="Optional shortcut for the bucket above. 10% means annual operating costs equal 10% of yearly rent.",
                example=10,
                default=10,
            ),
            OpportunityInputField(
                ...
                group="risk",
                value_type="percent",
                description="Expected percentage of rent lost to vacancy. Default is 0%.",
                example=0,
                default=0,
            ),
            OpportunityInputField(
            ...
            OpportunityInputField(
                ...
                group="risk",
                value_type="percent",
                description="Used to show real leveraged ROI after inflation. Example: 1.5 means 1.5% inflation.",
                example=1.5,
                default=1.5,
            ),
        ]
